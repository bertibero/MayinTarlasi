...
public class MineSweeper {
    ...
    public MineSweeper(int row, int column) {
        ...
        this.locationsOfMines =new int[row * column][2];
        placeMines ();
    }
        ...
        for (int i = 0; i < gameField.length; i++){
            for (int j = 0; j < gameField[i].length; j++){
                ...
                if (random >= 7 && mines < numberOfMines){
                    gameField[i][j] = "*";
                    locationsOfMines[mines][0] = i;
                    locationsOfMines[mines][1] = j;
                    mines++;
                }else{
                    gameField[i][j] = "-";
                }
    ...
    public void run(){
        ...
        System.out.println("Mayınların lokasyonları :");
